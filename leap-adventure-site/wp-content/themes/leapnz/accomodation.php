<?php 
/*Template Name: Accomodation Single Template*/

  // INIT ACC FEATURED POD
  $accomodationPermaLink = pods_var(-1, 'url');
  $podName1 = "accomodation"; // pod name
  $featuredPod = pods($podName1, $accomodationPermaLink); //create new pod from results of $podname
  $accomodationsPod = pods($podName1);
  $params = array( 'orderby' => 'name ASC'); //filter results
  $accomodationsPod->find($params); //apply the filters
              ...
              <section id="nearby-activities">
                ...
                <section id="nearby-accommodation">
                  <div class="container">
                      ...
                      ?> 
                      <?php if ( $accPod->field('id') != $featuredPod->field('id') ): ?>                      
                 <div class="content clearfix">
                  <div class="subcontent-1 clearfix">
                    <div class="image-title-rating">
